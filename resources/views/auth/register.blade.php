...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card bg-transparent shadow-lg text-light">
                <div class="card-header text-light text-center text-uppercase fw-bold">{{ __('Register') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-light text-md-end">{{ __('Fullname') }}</label>
